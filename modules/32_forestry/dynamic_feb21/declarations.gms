...
parameters
 ...
 p32_cdr_ac(t,j,type32_sub,ac)                      Non-cumulative CDR from afforestation plantations for each age-class depending on planning horizon (tC per ha)
...
equations
 ...
 q32_bv_ref(j,potnatveg)                           Biodiversity value for ref forestry land (Mha)
